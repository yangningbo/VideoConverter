...
public class OutputSurface implements SurfaceTexture.OnFrameAvailableListener {
    ...
    private void eglSetup(int width, int height) {
        ...
        int[] attribList = {EGL10.EGL_RED_SIZE, 8, EGL10.EGL_GREEN_SIZE, 8,
        ...
        if (!mEGL.eglChooseConfig(mEGLDisplay, attribList, configs,
            ...
            throw new RuntimeException(
                    "unable to find RGB888+pbuffer EGL config");
        }
        ...
        int[] surfaceAttribs = {EGL10.EGL_WIDTH, width, EGL10.EGL_HEIGHT,
                height, EGL10.EGL_NONE};
        mEGLSurface = mEGL.eglCreatePbufferSurface(mEGLDisplay, configs[0],
                surfaceAttribs);
